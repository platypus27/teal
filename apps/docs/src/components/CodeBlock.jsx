  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-outline-variant/30 bg-surface-container">
      <div className="flex items-center justify-between border-b border-outline-variant/30 px-4 py-2">
        <span className="font-mono text-xs font-semibold text-on-surface-variant">{label ?? lang}</span>
      ...
      <pre
        ...
        tabIndex={0}
        className={`language-${lang} docs-code overflow-x-auto p-4 text-[13px] leading-relaxed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary`}
      >
