...
const markdown = gettingStartedMarkdown()
...
export function HomeContent({ onMarkdown }) {
  useEffect(() => {
    onMarkdown(markdown)
  }, [onMarkdown])
  ...
  return (
    <>
      <div className="flex flex-wrap gap-3">
        <Button asChild>
          <a href="/modules/button">
            Explore modules <ArrowRight />
          </a>
        </Button>
        <Button asChild variant="secondary">
          <a href="/foundations">Read foundations</a>
        </Button>
      </div>
      ...
      <Section
        title="Modules"
        description="200 typed modules across nine groups. Each page ships live examples, a playground, a generated interface reference, and keyboard documentation."
      >
