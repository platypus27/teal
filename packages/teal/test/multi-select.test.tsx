...
describe('MultiSelect', () => {
  it('renders the label and placeholder', () => {
    render(<MultiSelect label="Project roles" placeholder="Pick roles" options={options} />)
  ...
  it('opens a multi-selectable listbox and toggles options without closing', async () => {
    ...
    render(<MultiSelect label="Project roles" options={options} onValueChange={onValueChange} />)
    const control = screen.getByRole('combobox', { name: 'Project roles' })
    ...
    expect(screen.getByRole('option', { name: 'Editor' })).toHaveAttribute('aria-selected', 'true')
