export function EmptyState({ icon = 'inbox', title = 'Nothing here', message, className = '' }) {
  return (
    <div className={`flex flex-col items-center justify-center rounded-[1.5rem] border border-outline-variant/10 bg-surface-container p-10 text-center ${className}`}>
