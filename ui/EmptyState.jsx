...
export function EmptyState({ icon = 'inbox', title = 'Nothing here', message, className = '' }) {
  return (
    <div className={cn('flex flex-col items-center justify-center rounded-2xl border border-outline-variant/10 bg-surface-container p-10 text-center', className)}>
